...
FECHA: 2/5/24
PROGRAMA: Uso de funciones recursivas
Universidad De Guadalajara // Centro Universitario de los Altos // Ing. en Computación // 2° Semestre
PROFESOR: Carlos Javier Cruz Franco
DESCRIPCIÓN: Llama a las funciones de manera recursiva para agregar y mostrar los valores en un arreglo
----------------------- */
...
int mostrarValores(int n)
{
  ...
  {
    std::cout<< n<< ". "<< "( "<< vectorPrincipal[n]<< " )"<< " ";

    return mostrarValores(n + 1);
  }
}
